...
func TestDHCPConfig_OK(t *testing.T) {
	s := newDHCPConfigServer(t, mockGetter{
		"/dhcp/config/": DHCPConfig{
			Enabled: true, GatewayIP: "192.168.100.254",
			IPRangeStart: "192.168.100.10", IPRangeEnd: "192.168.100.199",
		},
	})
	...
	if !strings.Contains(result.Content[0].(mcp.TextContent).Text, "192.168.100.254") {
