...
func TestRoutesIPv4_OK(t *testing.T) {
	s := newNetworkServer(t, mockGetter{
		"/network/route/ipv4/": []StaticRoute{
			{ID: "r1", IP: "10.0.0.0", Mask: "255.255.255.0", Gateway: "192.168.100.11", Active: true, Comment: "CoreOS VMs"},
		},
	})
...
func TestRouteAdd_OK(t *testing.T) {
	s := newNetworkServer(t, mockGetter{
		"/network/route/ipv4/": StaticRoute{ID: "r2", IP: "172.16.0.0", Mask: "255.255.0.0", Gateway: "192.168.100.11", Active: true},
	})
