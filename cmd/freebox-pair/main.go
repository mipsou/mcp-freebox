...
var freeboxPermissions = []permission{
	...
	{"Accès à la base de contacts", "Lecture/Écriture", true, "Répertoire téléphonique (freebox_contacts, freebox_contact_get)"},
	{"Accès au journal d'appels", "Lecture", true, "Historique des appels (freebox_call_log)"},
	{"Accès au guide TV", "Lecture", true, "Chaînes TV (freebox_tv_channels)"},
	{"Programmation des enregistrements", "Lecture/Écriture", true, "Enregistrements TV (freebox_tv_records)"},
